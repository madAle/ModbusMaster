    ...
    switch(u8ModbusADU[1])
    {
      ...
      case ku8MBReadDiscreteInputs:
        ...
        for (i = 0; i < (u8ModbusADU[2] >> 1); i++)
        {
          ...
          {
            _u16ResponseBuffer[i] = ((uint16_t)u8ModbusADU[2 * i + 4] << 8) | (uint16_t)u8ModbusADU[2 * i + 3];  //word(u8ModbusADU[2 * i + 4], u8ModbusADU[2 * i + 3]);
          }
        ...
        if (u8ModbusADU[2] % 2)
        {
          if (i < ku8MaxBufferSize)
          {
            _u16ResponseBuffer[i] =  (uint16_t)u8ModbusADU[2 * i + 3]; //word(0, u8ModbusADU[2 * i + 3]);
          }
      ...
      case ku8MBReadWriteMultipleRegisters:
        ...
        for (i = 0; i < (u8ModbusADU[2] >> 1); i++)
        {
          if (i < ku8MaxBufferSize)
          {
            _u16ResponseBuffer[i] = ((uint16_t)u8ModbusADU[2 * i + 3] << 8) | (uint16_t)u8ModbusADU[2 * i + 4]; //word(u8ModbusADU[2 * i + 3], u8ModbusADU[2 * i + 4]);
          }
